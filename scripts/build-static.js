...
const VERSIONED_ASSETS = {
  "styles.css": "styles.v22.css",
  "app.js": "app.v22.js",
  "offline-db.js": "offline-db.v22.js",
  "sync-service.js": "sync-service.v22.js"
};
...
async function build() {
  ...
  await fs.writeFile(path.join(OUT_DIR, "env-config.v22.js"), buildEnvConfig(), "utf8");
...
async function writeLocalPreviewAliases() {
  ...
  await fs.writeFile(path.join(ROOT, "env-config.v22.js"), buildEnvConfig(), "utf8");
}
